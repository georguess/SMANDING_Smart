...
export default function Index({ admins, filters }) {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get("/admin/admins", { search }, { preserveState: true, replace: true });
    };
    const handleDelete = (id) => {
        openModal("Yakin ingin menghapus akun admin? Data tidak bisa dikembalikan.", () => {
            router.delete(`/admin/students/${id}`);
            closeModal();
        });
    };
    const handleResetPassword = (id) => {
        openModal("Reset password admin ke password default (Smanding@26)?", () => {
