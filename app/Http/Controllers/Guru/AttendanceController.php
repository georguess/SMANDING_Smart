...
class AttendanceController extends Controller
{
    ...
    public function classAttendance(Request $request, Kelas $kelas)
    {
        ...
        // Keamanan: guru hanya boleh membuka kelas yang dia walikan
    ...
    public function updateStatus(Request $request, Attendance $attendance)
    {
        ...
        // Keamanan: guru hanya boleh update absensi kelas yang dia walikan
    ...
    public function exportCsv(Request $request, Kelas $kelas)
{
    ...
    $fileName = 'absensi_' . str_replace(' ', '_', strtolower($kelas->nama_kelas)) . '_' . $bulan . '_' . $tahun . '.csv';
